...
<head>
	...
	<link rel="shortcut icon" href="{$ThemeDir}/md/favicon0.htm">
	<link href="{$ThemeDir}/md/css00000.css" rel="stylesheet" type="text/css">
	<link href="{$ThemeDir}/md/css00001.css" rel="stylesheet" type="text/css">
