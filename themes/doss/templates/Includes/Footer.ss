<div id="footer">
	<div class="container">
		<div id="footer-header">
			<p><a href="http://www.uiowa.edu/"><img src="$ThemeDir/images/logo-footer.png" alt="The University of Iowa - Logo" /></a></p>
			<div id="footer-search">
				<form action="/home/SearchForm" method="get" accept-charset="utf-8">
					...
					<input type="image" name="submit" value="" title="Search Button" id="search-submit" src="$ThemeDir/images/search-icon.png" />
				</form>			
			</div>
		...
		<div id="footer-contact">
			...
			<!-- END hCard -->
			<div id="copyright">
				<p>&copy; $Now.Year <a href="#">The University of Iowa</a>. All Rights Reserved.<br/>Site designed by IMU Marketing &amp; Design.</p>
			</div>
		</div>
		<div class="clearfix"></div>
	</div>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-426753-36']);
