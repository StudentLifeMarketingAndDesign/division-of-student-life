<?php
class AssessmentCoordinatorProfile extends Page {

	public static $db = array(
	
		/*"PublishedDate" => "SS_Datetime",*/
		
		//[name] [department] [content] [publish date] [head shot image square]
		"PersonName" => "Varchar(155)",
		"DepartmentName" => "Varchar(155)",
		"PublishedDate" => "Date",
		"ExternalURL" => "Text"
...
class AssessmentCoordinatorProfileController extends Page_Controller {
